globalThis.__timing__.logStart('Load chunks/server');import { getCurrentInstance, version, useSSRContext, defineComponent, ref, withAsyncContext, mergeProps, unref, createApp, reactive, toRef, onServerPrefetch, h, Suspense, nextTick, Transition, computed, provide, onErrorCaptured, inject, shallowRef, isReadonly, withCtx, createTextVNode, defineAsyncComponent, isRef, watchEffect, watch, resolveComponent } from 'vue';
...
import { isEqual, hasProtocol, parseURL, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from 'ufo';
...
const components = {
  Header: /* @__PURE__ */ defineAsyncComponent(() => Promise.resolve().then(function() {
    return Header;
  }).then((c) => c.default || c)),
  NewTask: /* @__PURE__ */ defineAsyncComponent(() => import(
    './NewTask-80ddf1de.mjs'
    /* webpackChunkName: "components/new-task" */
  ).then((c) => c.default || c)),
  TopButton: /* @__PURE__ */ defineAsyncComponent(() => import(
    './TopButton-1feba0e1.mjs'
    /* webpackChunkName: "components/top-button" */
  ).then((c) => c.default || c))
};
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1, maximum-scale=1.0" }, { "hid": "description", "name": "description", "content": "Здесь немного обо мне и задачах, с которыми работал..." }], "link": [{ "rel": "icon", "hid": "icon", "type": "image/png", "sizes": "16x16", "href": "/vue/favicon-16x16.png" }, { "rel": "icon", "hid": "icon", "type": "image/png", "sizes": "32x32", "href": "/vue/favicon-32x32.png" }, { "rel": "preload", "as": "font", "type": "font/woff2", "href": "/vue/font/merriweather-bold.woff2", "crossorigin": "anonymous" }, { "rel": "preload", "as": "font", "type": "font/woff2", "href": "/vue/font/merriweather-regular.woff2", "crossorigin": "anonymous" }], "style": [], "script": [], "noscript": [], "htmlAttrs": { "lang": "ru" }, "title": "Frontend Developer - Magomed Gasanov" };
const appPageTransition = false;
const appKeepalive = false;
const unhead_wcERhbk2Mk = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const vueuse_head_polyfill_0SZjJjUcje = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-7a6958b1.mjs').then((m) => m.default || m)
  },
  {
    name: "tasks",
    path: "/tasks",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-dd0f1adc.mjs').then((m) => m.default || m)
  }
];
...
const router_t6jlgeUNZP = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b;
  let __temp, __restore;
...
const plugin_SjrWhxHRlu = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const errorHandler_x1Y4n5NP4w = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  unhead_wcERhbk2Mk,
  vueuse_head_polyfill_0SZjJjUcje,
  router_t6jlgeUNZP,
  plugin_SjrWhxHRlu,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<header${ssrRenderAttrs(_attrs)}><div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 font-normal"><div class="flex h-16 items-center justify-center"><nav><ul class="flex items-center gap-6 text-lg"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "text-gray-900 transition hover:underline",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const page = ref(0);
    const { data: tasks, error, pending } = ([__temp, __restore] = withAsyncContext(() => useLazyAsyncData(
      () => $fetch("/api/tasks/", {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ml-auto mr-auto max-w-2xl min-h-full pt-8 pb-5 px-5" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_Header, null, null, _parent));
      _push(ssrRenderComponent(_component_NuxtPage, {
        tasks: unref(tasks),
        page: unref(page),
        loading: unref(pending),
        onChangePage: ($event) => page.value = $event
      }, null, _parent));
      _push(`</div>`);
    };
  }
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-89b5b98c.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-361b9a66.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.3.2_bcnce6t2n5ss3lv2getliffzhq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, createError as c, entry$1 as default, useNuxtApp as u };;globalThis.__timing__.logEnd('Load chunks/server');
