globalThis.__timing__.logStart('Load chunks/renderer');import { createRenderer } from 'vue-bundle-renderer/runtime';
...
export { buildAssetsURL as b, renderer$1 as r };;globalThis.__timing__.logEnd('Load chunks/renderer');
